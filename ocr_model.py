...
def find_numplate(img):#pathed
    ...
    for i in plate_infos:
        if i['w'] < rw:
            infos.append([i['x'], i['y'], i['w'], i['h']])
            rw = i['w']
    print("infos", infos)
    x, y, w, h = infos[-1][0], infos[-1][1], infos[-1][2], infos[-1][3]
    st.write("""
     # The Result of Numplate Location Detection : Crop Image
     """
     )
    ...
    st.write("""
        # Covering of Numplate : For Used Car
        """
        )
    return img
